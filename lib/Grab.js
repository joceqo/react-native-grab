...
function GrabInner({ children }) {
    ...
    const { selected, hovered, handleMove, handleTap, clearSelection } = (0, useTapToSelect_1.useTapToSelect)(snapshot);
    ...
    const layer = (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(GrabPanel_1.GrabPanel, { element: selected, onClose: clearSelection }),
