...
function GrabInner({ children }) {
    ...
    const layer = (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        isActive && !selected && reticle && hovered && (react_1.default.createElement(react_native_1.View, { pointerEvents: "none", style: [
                styles.label,
                { left: Math.max(6, Math.min(reticle.x - 80, width - 166)), top: Math.max(6, reticle.y - 48) },
            ] },
            react_1.default.createElement(react_native_1.Text, { numberOfLines: 1, style: styles.labelText },
                hovered.componentName,
                " \u00B7 ",
                Math.round(hovered.width),
                "\u00D7",
                Math.round(hovered.height)))),
