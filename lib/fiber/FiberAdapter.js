...
function isInactiveScreen(fiber) {
    if (typeof fiber.type !== 'string' || fiber.type !== 'RNSScreen')
        return false;
    const props = fiber.memoizedProps;
    if (typeof (props === null || props === void 0 ? void 0 : props.activityState) === 'number')
        return props.activityState === 0;
    if (typeof (props === null || props === void 0 ? void 0 : props.active) === 'number')
        return props.active === 0; // legacy prop
    return false;
}
