...
function GrabPanel({ element, matchCount = 0, matchIndex = 0, onParent, onChild, onClose, }) {
    var _a, _b;
    ...
    const topPad = atTop ? (react_native_1.Platform.OS === 'android' ? (_a = react_native_1.StatusBar.currentHeight) !== null && _a !== void 0 ? _a : 24 : 59) : 0;
    (0, react_1.useEffect)(() => {
    ...
    react_1.default.createElement(react_native_1.Animated.View, { style: [
        ...
        react_1.default.createElement(react_native_1.View, { style: [styles.panel, { maxHeight: Math.round(height * 0.5) + topPad, paddingTop: topPad }], onLayout: (e) => setSheetH(e.nativeEvent.layout.height) },
            ...
            react_1.default.createElement(react_native_1.View, { style: styles.header },
                react_1.default.createElement(react_native_1.View, { style: styles.headerMeta },
                    react_1.default.createElement(react_native_1.Text, { style: styles.componentName, numberOfLines: 1 }, (_b = element === null || element === void 0 ? void 0 : element.componentName) !== null && _b !== void 0 ? _b : ''),
            ...
            element && matchCount > 1 && (react_1.default.createElement(react_native_1.View, { style: styles.navRow },
                react_1.default.createElement(react_native_1.TouchableOpacity, { style: [styles.navBtn, matchIndex <= 0 && styles.navBtnDisabled], onPress: onChild, disabled: matchIndex <= 0, activeOpacity: 0.8 },
                    react_1.default.createElement(react_native_1.Text, { style: styles.navBtnText }, "\u2193 Enfant")),
                react_1.default.createElement(react_native_1.Text, { style: styles.navIndex },
                    matchIndex + 1,
                    "/",
                    matchCount),
                react_1.default.createElement(react_native_1.TouchableOpacity, { style: [styles.navBtn, matchIndex >= matchCount - 1 && styles.navBtnDisabled], onPress: onParent, disabled: matchIndex >= matchCount - 1, activeOpacity: 0.8 },
                    react_1.default.createElement(react_native_1.Text, { style: styles.navBtnText }, "\u2191 Parent")))),
